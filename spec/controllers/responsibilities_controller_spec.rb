...
RSpec.describe ResponsibilitiesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Responsibility" do
        expect {
          post :create, params: {responsibility: valid_attributes}, session: valid_session
        }.to change(Responsibility, :count).by(1)
      end

      it "redirects to the created responsibility" do
        post :create, params: {responsibility: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Responsibility.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the responsibility" do
        responsibility = Responsibility.create! valid_attributes
        put :update, params: {id: responsibility.to_param, responsibility: valid_attributes}, session: valid_session
        expect(response).to redirect_to(responsibility)
      end
    end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested responsibility" do
      responsibility = Responsibility.create! valid_attributes
      expect {
        delete :destroy, params: {id: responsibility.to_param}, session: valid_session
      }.to change(Responsibility, :count).by(-1)
    end
    ...
    it "redirects to the responsibilities list" do
      responsibility = Responsibility.create! valid_attributes
      delete :destroy, params: {id: responsibility.to_param}, session: valid_session
      expect(response).to redirect_to(responsibilities_url)
    end
  end
