...
RSpec.describe MerkmaleController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested merkmal as @merkmal" do
      merkmal = Merkmal.create! valid_attributes
      get :show, {:id => merkmal.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested merkmal as @merkmal" do
      merkmal = Merkmal.create! valid_attributes
      get :edit, {:id => merkmal.to_param}, valid_session
      expect(assigns(:merkmal)).to eq(merkmal)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Merkmal" do
        expect {
          post :create, {:merkmal => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved merkmal as @merkmal" do
        post :create, {:merkmal => invalid_attributes}, valid_session
        expect(assigns(:merkmal)).to be_a_new(Merkmal)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested merkmal" do
        merkmal = Merkmal.create! valid_attributes
        put :update, {:id => merkmal.to_param, :merkmal => new_attributes}, valid_session
        merkmal.reload
      ...
      it "assigns the requested merkmal as @merkmal" do
        merkmal = Merkmal.create! valid_attributes
        put :update, {:id => merkmal.to_param, :merkmal => valid_attributes}, valid_session
        expect(assigns(:merkmal)).to eq(merkmal)
      end
    ...
    describe "with invalid params" do
      it "assigns the merkmal as @merkmal" do
        merkmal = Merkmal.create! valid_attributes
        put :update, {:id => merkmal.to_param, :merkmal => invalid_attributes}, valid_session
        expect(assigns(:merkmal)).to eq(merkmal)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested merkmal" do
      merkmal = Merkmal.create! valid_attributes
      expect {
        delete :destroy, {:id => merkmal.to_param}, valid_session
      }.to change(Merkmal, :count).by(-1)
    end
