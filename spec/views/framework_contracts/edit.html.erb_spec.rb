...
RSpec.describe "framework_contracts/edit", type: :view do
  before(:each) do
    @ability = Object.new
  ...
  it "renders the edit framework_contract form" do
    render

    assert_select "form[action=?][method=?]", framework_contract_path(@framework_contract), "post" do
